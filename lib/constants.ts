...
/**
 * POI scoring and distance matrix constants
 */
export const TOP_N_POI = 120;
export const TOP_N_MATRIX = 40;

/**
 * Scoring weights for POI evaluation
 */
...
/**
 * Weather thresholds for scoring
 */
export const WEATHER_THRESHOLDS = {
  HOT_FEELS_LIKE_CELSIUS: 35,
  RAIN_PROBABILITY_THRESHOLD: 0.5, // 50%
  WIND_SPEED_THRESHOLD_KMH: 25,
} as const;
