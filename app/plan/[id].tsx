...
export default function PlanDetails() {
  ...
  const plan: Plan | null = useMemo(() => {
    try { return JSON.parse(params.payload as string); } catch { return null; }
  }, [params.payload]);

  const webRef = useRef<WebView>(null);

  if (!plan) {
    return <View style={{ padding: 16 }}><Text>Plan invalid.</Text></View>;
  }
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ padding: 12, borderBottomWidth: 1, borderColor: "#333", backgroundColor: "#111" }}>
