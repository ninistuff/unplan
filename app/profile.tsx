    ...
    >
      <View style={{ flex: 1 }}>
        ...
        >
          <Section title={""}>
            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
              <View style={{ position: "relative", marginRight: 16, marginTop: 8 }}>
                <Image
                  source={local.avatarUri ? { uri: local.avatarUri } : undefined}
                  style={{ width: 96, height: 96, borderRadius: 48, backgroundColor: "#e5e7eb" }}
                />
                <Pressable
                  onPress={onPickAvatar}
                  accessibilityLabel={lang === "ro" ? "Schimbă poza" : "Change photo"}
                  style={{
                    position: "absolute",
                    right: -6,
                    bottom: -6,
              ...
              <View style={{ flex: 1, paddingLeft: 16 }}>
                ...
                {showDobPicker ? (
                  <DateTimePicker
                    value={parseIso(local.dob || toIso(new Date(1995, 0, 1)))}
                    mode="date"
                    display={Platform.OS === "ios" ? "inline" : "default"}
                    onChange={(_e: DateTimePickerEvent, d?: Date) => {
                      if (Platform.OS === "android") setShowDobPicker(false);
                      if (d) setLocal({ ...local, dob: toIso(d) });
                    }}
                  />
                ) : null}
              </View>
            ...
            <View style={{ flexDirection: "row", gap: 8 }}>
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    themeMode === "light" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
              ...
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    themeMode === "dark" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
              ...
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    themeMode === "auto" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
            ...
            <View style={{ flexDirection: "row", gap: 8 }}>
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    textSize === "small" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
              ...
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    textSize === "medium" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
              ...
              <Pressable
                ...
                style={{
                  ...
                  borderRadius: 8,
                  backgroundColor:
                    textSize === "large" ? theme.colors.accent : theme.colors.surface,
                  borderWidth: 1,
          ...
          >
            <Text
              style={{ color: "#ef4444", textAlign: "center", fontWeight: "700", fontSize: 16 }}
            >
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  ...
  return (
    <View style={{ gap: 12 }}>
      {title ? (
        <Text style={{ fontSize: theme.textSizes.lg, fontWeight: "700", color: theme.colors.text }}>
          {title}
        </Text>
      ) : null}
      {children}
